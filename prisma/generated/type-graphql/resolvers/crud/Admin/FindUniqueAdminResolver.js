...
exports.FindUniqueAdminResolver = void 0;
...
let FindUniqueAdminResolver = class FindUniqueAdminResolver {
...
], FindUniqueAdminResolver.prototype, "admin", null);
FindUniqueAdminResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Admin_1.Admin)
], FindUniqueAdminResolver);
exports.FindUniqueAdminResolver = FindUniqueAdminResolver;
