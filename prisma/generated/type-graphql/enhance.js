...
const modelsInfo = {
    ...
    Coach: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "userId"],
    ...
    WorkoutToDo: ["id", "date", "goal", "coachId", "athleteId"]
};
...
const outputsInfo = {
    ...
    CoachGroupBy: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "userId", "_count", "_min", "_max"],
    ...
    AggregateWorkoutToDo: ["_count", "_min", "_max"],
    WorkoutToDoGroupBy: ["id", "date", "goal", "coachId", "athleteId", "_count", "_min", "_max"],
    ...
    CoachCount: ["WorkoutToDo"],
    CoachCountAggregate: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "userId", "_all"],
    CoachMinAggregate: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "userId"],
    CoachMaxAggregate: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "userId"],
    ...
    WorkoutToDoCountAggregate: ["id", "date", "goal", "coachId", "athleteId", "_all"],
    WorkoutToDoMinAggregate: ["id", "date", "goal", "coachId", "athleteId"],
    WorkoutToDoMaxAggregate: ["id", "date", "goal", "coachId", "athleteId"]
};
...
const inputsInfo = {
    ...
    CoachWhereInput: ["AND", "OR", "NOT", "id", "name", "lastname", "schoolId", "description", "gender", "status", "user", "userId", "WorkoutToDo"],
    CoachOrderByWithRelationInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "user", "userId", "WorkoutToDo"],
    CoachWhereUniqueInput: ["id", "schoolId", "userId"],
    CoachOrderByWithAggregationInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "userId", "_count", "_max", "_min"],
    CoachScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "lastname", "schoolId", "description", "gender", "status", "userId"],
    ...
    WorkoutToDoWhereInput: ["AND", "OR", "NOT", "id", "coach", "athlete", "date", "goal", "coachId", "athleteId"],
    WorkoutToDoOrderByWithRelationInput: ["id", "coach", "athlete", "date", "goal", "coachId", "athleteId"],
    WorkoutToDoWhereUniqueInput: ["id"],
    WorkoutToDoOrderByWithAggregationInput: ["id", "date", "goal", "coachId", "athleteId", "_count", "_max", "_min"],
    WorkoutToDoScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "date", "goal", "coachId", "athleteId"],
    ...
    CoachCreateInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "user", "WorkoutToDo"],
    CoachUpdateInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "user", "WorkoutToDo"],
    CoachCreateManyInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "userId"],
    CoachUpdateManyMutationInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status"],
    ...
    WorkoutToDoCreateInput: ["id", "coach", "athlete", "date", "goal"],
    WorkoutToDoUpdateInput: ["id", "coach", "athlete", "date", "goal"],
    WorkoutToDoCreateManyInput: ["id", "date", "goal", "coachId", "athleteId"],
    WorkoutToDoUpdateManyMutationInput: ["id", "date", "goal"],
    ...
    CoachCountOrderByAggregateInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "userId"],
    CoachMaxOrderByAggregateInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "userId"],
    CoachMinOrderByAggregateInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "userId"],
    ...
    WorkoutToDoCountOrderByAggregateInput: ["id", "date", "goal", "coachId", "athleteId"],
    WorkoutToDoMaxOrderByAggregateInput: ["id", "date", "goal", "coachId", "athleteId"],
    WorkoutToDoMinOrderByAggregateInput: ["id", "date", "goal", "coachId", "athleteId"],
    ...
    CoachCreateWithoutUserInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "WorkoutToDo"],
    ...
    CoachUpdateWithoutUserInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "WorkoutToDo"],
    ...
    WorkoutToDoCreateWithoutCoachInput: ["id", "athlete", "date", "goal"],
    ...
    WorkoutToDoScalarWhereInput: ["AND", "OR", "NOT", "id", "date", "goal", "coachId", "athleteId"],
    ...
    WorkoutToDoCreateWithoutAthleteInput: ["id", "coach", "date", "goal"],
    ...
    CoachCreateWithoutWorkoutToDoInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "user"],
    ...
    CoachUpdateWithoutWorkoutToDoInput: ["id", "name", "lastname", "schoolId", "description", "gender", "status", "user"],
    ...
    WorkoutToDoCreateManyCoachInput: ["id", "date", "goal", "athleteId"],
    WorkoutToDoUpdateWithoutCoachInput: ["id", "athlete", "date", "goal"],
    WeightCreateManyAthleteInput: ["id", "weight", "date"],
    DoneWorkoutCreateManyAthleteInput: ["id", "date", "calories", "time", "distance", "intensity"],
    WorkoutToDoCreateManyAthleteInput: ["id", "date", "goal", "coachId"],
    ...
    WorkoutToDoUpdateWithoutAthleteInput: ["id", "coach", "date", "goal"]
};
